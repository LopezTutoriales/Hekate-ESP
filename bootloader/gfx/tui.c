...
void tui_sbar(bool force_update)
{
	...
	gfx_printf("%K%k Bateria: %d.%d%% (%d mV) - Carga:", TXT_CLR_GREY_D, TXT_CLR_GREY,
...
void *tui_do_menu(menu_t *menu)
{
	...
	while (true)
	{
		...
		gfx_printf("%k Advert: %kNyx no esta!", TXT_CLR_RED_D, TXT_CLR_GREY_M);
		gfx_con_setpos(0,  1191);
		gfx_printf("%k VOL: Mover arriba/abajo\n PWR: Seleccionar opcion%k", TXT_CLR_GREY_M, TXT_CLR_DEFAULT);
