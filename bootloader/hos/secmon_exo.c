...
void secmon_exo_check_panic()
{
	...
	WPRINTF("Ocurrio un error al ejecutar Atmosphere.\n\n");
	WPRINTFARGS("ID Titulo: %08X%08X", (u32)((u64)rpt->title_id >> 32), (u32)rpt->title_id);
	...
	{
		gfx_con.fntsz = 8;
		WPRINTFARGS("Reporte guardado en %s\n", filepath);
		gfx_con.fntsz = 16;
	}
